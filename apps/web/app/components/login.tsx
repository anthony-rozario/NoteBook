export default function Login() {
    return (
            <div className="w-full space-y-6 border-1px border-slate-500 shadow-2xl text-gray-600 sm:max-w-md p-6 rounded-sm bg-white">
                <div className="text-center">
                    <img src="/n-logo.png" width={50} className="mx-auto" />
                    <p className="text-xl font-bold text-slate-950">NoteBook</p>
                    <div className="mt-5 space-y-2">
                        <h3 className="text-gray-800 text-2xl font-bold sm:text-2xl">Log in to your account</h3>
                ...
                <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    <div className="grid grid-cols-2 gap-x-2"> 
                        <button className="flex items-center justify-center hover:cursor-pointer py-2.5 border-1px border border-gray-400 rounded-lg hover:bg-gray-200 duration-150 active:bg-gray-100">
                        ...
                        <button className="flex items-center justify-center py-2.5 hover:cursor-pointer border-1px border border-gray-400 hover:bg-gray-200 rounded-lg  duration-150 active:bg-gray-100">
                            <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-white rounded-full border py-1 border-1px border-gray-300 px-2 m-auto absolute top-1/2 -translate-y-1/2 w-fit items-center text-center left-1/2 -translate-x-1/2">
                            Or continue with
                        </div>
                    </div>
                    <form
